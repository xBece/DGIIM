...
int main () {
	...
	cout << "Este programa le permitirá anotar el número de ventas de productos determinados por su código en cada sucursal y, posteriormente, ver cual ha sido la que ha producido mayor número de ventas.";
